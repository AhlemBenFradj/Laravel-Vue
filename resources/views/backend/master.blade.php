...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li> <a href="/students" data-toggle="tooltip" data-plcement="right" title="Home Page"> List Students </a></li>
                        <li> <a href="/tasks" data-toggle="tooltip" data-plcement="right" title="Home Page"> Add Task </a></li>
                    </ul>
                </nav>
                <!-- /.sidebar-menu -->
            </div>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2023-2024 <a href="https://www.linkedin.com/in/ahlem-ben-fraj/">Ahlem Ben Fradj</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
